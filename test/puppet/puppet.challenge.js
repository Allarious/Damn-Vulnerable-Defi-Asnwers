...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        console.log("Attacker Token Balance: ", await this.token.balanceOf(attacker.address));
        ...
        console.log("Required Ether to deposit is:", ethers.utils.formatEther(await this.lendingPool.connect(attacker).calculateDepositRequired(POOL_INITIAL_TOKEN_BALANCE)) + " ETH");
    });
