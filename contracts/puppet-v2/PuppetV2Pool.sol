...
contract PuppetV2Pool {
    ...
    constructor (
        ...
        _weth = IERC20(wethAddress); // It implements everything but doesn't really inherit from IERC20
    ...
    function borrow(uint256 borrowAmount) external {
        ...
        // console.log("The WETH deposit amount is: ", depositOfWETHRequired / 10 ** 18);
